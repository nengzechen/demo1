# Play Framework 用户权限管理系统 API设计文档
...
本文档描述了基于Play Framework开发的用户权限管理系统RESTful API接口规范。
...
**接口路径**: `/api/management/users/username/{username}`
...
**接口路径**: `/api/management/users/search`
...
**接口路径**: `/api/management/users/by-status`
...
**接口路径**: `/api/management/users/batch`
...
**接口路径**: `/api/management/roles/code/{code}`
...
**接口路径**: `/api/management/roles/search`
...
**接口路径**: `/api/management/roles/batch`
...
**接口路径**: `/api/management/permissions`
